...
class TestPathMisc(TestCase):
    ...
    def test_calculate_commit_file_url_path_none(self):
        path = None
    ...
    def test_calculate_commit_file_url_empty_path(self):
        path = ""
        commit_file_url = calculate_commit_file_url(
            path=path,
            service=self.service,
    ...
    def test_calculate_commit_file_url_path_only_dirs(self):
    ...
    def test_calculate_commit_file_url_path_incomplete_dirs(self):
        path = "folder/to/subf"
        commit_file_url = calculate_commit_file_url(
            path=path,
            service=self.service,
    ...
    def test_calculate_commit_file_url_path_hidden_dirs(self):
    ...
    def test_calculate_commit_file_url_path_hidden_dirs_at_end_of_string(self):
    ...
    def test_calculate_commit_file_url_path_dir_and_filename(self):
    ...
    def test_calculate_commit_file_url_path_with_special_characters_and_filename(self):
