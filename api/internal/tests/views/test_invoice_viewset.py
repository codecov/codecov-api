...
class InvoiceViewSetTests(APITestCase):
    ...
    def test_invoices_returns_100_recent_invoices(
        self, mock_list_invoices_filtered_by_status_and_total
    ):
        ...
        mock_list_invoices_filtered_by_status_and_total.return_value = (
