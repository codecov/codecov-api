...
ENTERPRISE_CLOUD_YEARLY_PLAN_NAME = "users-enterprisey"
ENTERPRISE_CLOUD_MONTHLY_PLAN_NAME = "users-enterprisem"

ENTERPRISE_CLOUD_PLAN_NAMES = (
    ENTERPRISE_CLOUD_YEARLY_PLAN_NAME,
    ENTERPRISE_CLOUD_MONTHLY_PLAN_NAME,
)
