...
from .interactors.fetch_pull_commits import FetchPullCommitsInteractor
...
class CommitCommands(BaseCommand):
    ...
    def fetch_pull_commits(self, pull):
        return self.get_interactor(FetchPullCommitsInteractor).execute(pull)
