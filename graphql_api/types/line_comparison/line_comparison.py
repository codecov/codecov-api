...
def resolve_base_number(line_comparison: LineComparison, info):
    return line_comparison.number["base"]


@line_comparison_bindable.field("headNumber")
def resolve_head_number(line_comparison: LineComparison, info):
    return line_comparison.number["head"]


@line_comparison_bindable.field("baseCoverage")
def resolve_base_coverage(line_comparison: LineComparison, info):
...
def resolve_head_coverage(line_comparison: LineComparison, info):
...
def resolve_content(line_comparison: LineComparison, info):
