...
class UploadDownloadHelperTest(APITestCase):
    ...
    def test_invalid_archive_path(
        self, read_file, get_archive_hash, create_root_storage
    ):
    ...
    def test_valid_repo_archive_path(
        self, mock_read_file, get_archive_hash, create_root_storage
    ):
    ...
    @patch("services.archive.ArchiveService.create_root_storage")
    @patch("services.archive.ArchiveService.read_file")
    def test_invalid_repo_archive_path(self, mock_read_file, create_root_storage):
        mock_read_file.return_value = "Report!"
        response = self._get(
            kwargs={
                "service": "gh",
