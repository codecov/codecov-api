...
class ChangeWithParentInteractorTest(TransactionTestCase):
    def setUp(self):
        ...
        self.report_totals = ReportLevelTotalsFactory(report=self.report, coverage=79.38)
    ...
    def test_change_with_parent_with_coverage(self):
        change = async_to_sync(self.execute)(None, self.report_totals, self.report_totals_for_parent)
