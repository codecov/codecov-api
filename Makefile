...
test_env.prepare:
	docker-compose -f docker-compose-test.yml exec app make test_env.container_prepare

test_env.check_db:
	docker-compose -f docker-compose-test.yml exec app make test_env.container_check_db
...
test_env.run_unit:
	docker-compose -f docker-compose-test.yml exec app make test.unit

test_env.check-for-migration-conflicts:
	docker-compose -f docker-compose-test.yml exec app python manage.py check_for_migration_conflicts

test_env.upload:
	docker-compose -f docker-compose-test.yml exec app make test_env.container_upload CODECOV_UPLOAD_TOKEN=${CODECOV_UPLOAD_TOKEN} CODECOV_URL=${CODECOV_URL}
...
test_env.static_analysis:
	docker-compose -f docker-compose-test.yml exec app make test_env.container_static_analysis CODECOV_STATIC_TOKEN=${CODECOV_STATIC_TOKEN}

test_env.label_analysis:
	docker-compose -f docker-compose-test.yml exec app make test_env.container_label_analysis CODECOV_STATIC_TOKEN=${CODECOV_STATIC_TOKEN}

test_env.ats:
	docker-compose -f docker-compose-test.yml exec app make test_env.container_ats CODECOV_UPLOAD_TOKEN=${CODECOV_UPLOAD_TOKEN}
