...
def run_sql(schema_editor):
    schema_editor.execute(
        ...
        ALTER TABLE commits ADD PRIMARY KEY USING INDEX commits_pkey;
        ALTER TABLE commit_notifications ADD CONSTRAINT commit_notifications_commit_id_fkey FOREIGN KEY (commit_id) REFERENCES commits(id) ON DELETE CASCADE
        -- EOF
        BEGIN;
        --
        ...
        CREATE TABLE "reports_uploaderror" (
            ...
            "report_session_id" bigint NOT NULL
        );
        --
        ...
        --
        CREATE TABLE "reports_sessionleveltotals" (
            "id" bigserial NOT NULL PRIMARY KEY,
            "external_id" uuid NOT NULL,
            "created_at" timestamp with time zone NOT NULL,
            "updated_at" timestamp with time zone NOT NULL,
            ...
            "partials" integer NOT NULL,
            "files" integer NOT NULL,
            "report_session_id" bigint NOT NULL UNIQUE
        );
        --
        ...
        --
        ALTER TABLE "reports_uploadflagmembership" ADD COLUMN "report_session_id" bigint NOT NULL;
        --
        ...
        ALTER TABLE "reports_uploaderror" ADD CONSTRAINT "reports_reportsessio_report_session_id_bb6563f1_fk_reports_r" FOREIGN KEY ("report_session_id") REFERENCES "reports_upload" ("id") DEFERRABLE INITIALLY DEFERRED;
        CREATE INDEX "reports_uploaderror_report_session_id_bb6563f1" ON "reports_uploaderror" ("report_session_id");
        ...
        ALTER TABLE "reports_sessionleveltotals" ADD CONSTRAINT "reports_sessionlevel_report_session_id_e2cd6669_fk_reports_r" FOREIGN KEY ("report_session_id") REFERENCES "reports_upload" ("id") DEFERRABLE INITIALLY DEFERRED;
        ...
        CREATE INDEX "reports_uploadflagmembership_report_session_id_7d7f9546" ON "reports_uploadflagmembership" ("report_session_id");
        ALTER TABLE "reports_uploadflagmembership" ADD CONSTRAINT "reports_reportsessio_report_session_id_7d7f9546_fk_reports_r" FOREIGN KEY ("report_session_id") REFERENCES "reports_upload" ("id") DEFERRABLE INITIALLY DEFERRED;
