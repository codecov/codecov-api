...
class RepositoryViewSet(
    ...
    def get_queryset(self):
        ...
        if self.action == 'list':
            before_date = self.request.query_params.get("before_date", datetime.now(tz=UTC).isoformat())
    ...
    def statistics(self, request, *args, **kwargs):
        ...
        results = queryset.with_latest_commit_totals_before(
            self.request.query_params.get("before_date", datetime.now(tz=UTC).isoformat()),
